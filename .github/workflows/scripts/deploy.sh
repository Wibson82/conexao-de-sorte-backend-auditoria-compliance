...
# ============================================================================
# 🚀 SCRIPT DE DEPLOY SIMPLIFICADO - CONEXÃO DE SORTE GATEWAY
# ============================================================================
#
...
PROJECT_DIR="/opt/conexao-de-sorte/gateway"
...
services:
  gateway:
    image: ghcr.io/\${GITHUB_REPOSITORY:-conexao-de-sorte/conexao-de-sorte-backend-gateway}-gateway:\${IMAGE_TAG}
    ports:
      - "8080:8080"
    environment:
